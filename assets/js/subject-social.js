...
const { isProv, byDiffAsc, byDiffDesc, diffColor, bookName, normQ, coverSrcs, covErr, trapFocusables, modalOpened, modalClosed, openBox } = RTCommon;
...
/* 共通版（assets/js/subject-common.js）と違い、URL を属性値としてエスケープし、alt に書名を入れる。
   そろえると表示が変わるので、この科目だけ残している（仕様書 5.5） */
...
/* 共通版（assets/js/subject-common.js）と違い、60×60 以下の画像も「書影なし」とみなす。
   そろえると表示が変わるので、この科目だけ残している（仕様書 5.5） */

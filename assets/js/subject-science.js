...
const { isProv, byDiffAsc, byDiffDesc, diffColor, bookName, coverHTML, covLoad, covErr, trapFocusables, modalOpened, modalClosed, openBox } = RTCommon;
...
/* ============================================================
   志望校マッチング
   ============================================================ */
/* 共通版（assets/js/subject-common.js）と別物。大学名の正規化（ひらがな→カタカナ・「大学」を落とす）で、
   この科目の志望校検索はこの規則を前提にしている（仕様書 5.5） */
function normQ(s){

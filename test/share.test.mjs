...
const QUIZ_FINGERPRINTS = {
  /* 2026-09-04: 英語・数学の Q3 の末尾に「私立医学部」を足した（TIERS には
     shiritsui があるのに診断からたどり着けなかった）。**末尾への追加なので
     既存の選択肢の番号は動かず、過去に共有された URL は同じ回答へ復元される。**
     長さの検証は quiz.length と一致するかを見るだけで、質問数は増えていない。
     したがって SCHEMA_VERSION は据え置く。旧 URL が復元できることは
     「旧共有 URL が同じ結果へ復元される」で fixture ごと固定してある */
  english:  'e7afa8a1d062adf7',
  japanese: '22effa6ade60dcfd',
  math:     'e7afa8a1d062adf7',   /* english と同じ構造なので指紋も一致する */

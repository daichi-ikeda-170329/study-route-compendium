...
const STEPS = [
  ...
  { name: '手書き HTML のフッター', script: 'apply-footer.mjs',      checkArgs: ['--check'] },
  { name: '同意の既定値（Consent Mode）', script: 'apply-consent.mjs', checkArgs: ['--check'] },
  ...
  { name: '書影の出所台帳',        script: 'generate-cover-ledger.mjs',    checkArgs: ['--check'] },
